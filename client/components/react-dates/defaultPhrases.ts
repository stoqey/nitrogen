...
const chooseAvailableStartDate = ({ date }: WithDate) => `Choose ${date} as your check-in date. It’s available.`;
const chooseAvailableEndDate = ({ date }: WithDate) => `Choose ${date} as your check-out date. It’s available.`;
const chooseAvailableDate = ({ date }: WithDate) => date;
const dateIsUnavailable = ({ date }: WithDate) => `Not available. ${date}`;
const dateIsSelected = ({ date }: WithDate) => `Selected. ${date}`;
const dateIsSelectedAsStartDate = ({ date }: WithDate) => `Selected as start date. ${date}`;
const dateIsSelectedAsEndDate = ({ date }: WithDate) => `Selected as end date. ${date}`;
